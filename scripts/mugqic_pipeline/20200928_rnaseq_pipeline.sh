...
# Version: 3.1.5-beta
# Created on: 2020-09-28T17:59:34
# Steps:
...
#-------------------------------------------------------------------------------
LOG_MD5=$(echo $USER-'10.74.73.3-RnaSeq-UMSCC1_NTsh.UMSCC1_NTsh,UMSCC47_NTsh.UMSCC47_NTsh' | md5sum | awk '{ print $1 }')
wget "http://mugqic.hpc.mcgill.ca/cgi-bin/pipeline.cgi?hostname=beluga3.int.ets1.calculquebec.ca&ip=10.74.73.3&pipeline=RnaSeq&steps=picard_sam_to_fastq,trimmomatic,merge_trimmomatic_stats,star,picard_merge_sam_files,picard_sort_sam,picard_mark_duplicates,picard_rna_metrics,estimate_ribosomal_rna,bam_hard_clip,rnaseqc,wiggle,raw_counts,raw_counts_metrics&samples=2&md5=$LOG_MD5" --quiet --output-document=/dev/null
